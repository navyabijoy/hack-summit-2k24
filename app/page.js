...
export default function Home() {
  ...
  return (
    <Container maxWidth={false} disableGutters sx={{ overflow: "hidden" }}>
      <Head>
        <title>Unify</title>
        <meta name="description" content="Empowering silent voices." />
    ...
    >
      ...
      >
        ...
        >
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus viverra tellus in ex placerat, nec tempus lorem semper. Nunc id pharetra odio. Phasellus urna velit, cursus nec lorem eu, laoreet luctus lectus. Ut vel mi vel felis mattis ultrices at quis mi. Nunc ut erat turpis. Duis tincidunt urna sed tellus venenatis viverra. Morbi porta erat vitae purus dignissim, nec hendrerit magna tincidunt. Duis commodo a mauris id congue. Duis scelerisque enim libero, ut pharetra lectus accumsan eget.
        </Typography>
      </Box>
